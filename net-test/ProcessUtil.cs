...
namespace Microsoft.Crank.Agent
{
    public static class ProcessUtil
    {
        ...
        )
        {
            ...
            {
                Console.WriteLine("process.OutputDataReceived");
                if (e.Data != null)
                {
                    if (captureOutput)
                    {
            ...
            {
                Console.WriteLine("process.ErrorDataReceived");
                if (e.Data != null)
                {
                    if (captureError)
                    {
            ...
            Console.WriteLine($"processResult.ExitCode: {processResult.ExitCode}");
